...
<body>
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-sm lg:flex-grow">
      ...
      <a href="http://192.168.30.252:9091/ProjetoXoPlanilha/outlet/index.php" class="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter text-orange-300 text-lg">
        Outlet
      </a>
    </div>
    <!-- <div>
...
<a href="http://192.168.30.252:9091/ProjetoXoPlanilha/outlet/produtos_zerados.php" class="border-slate-900 border-2 rounded-2xl ml-6 p-2 text-black  hover:bg-gray-200">
        Lista de produtos que acabaram em estoque
</a>
<a href="http://192.168.30.252:9091/ProjetoXoPlanilha/outlet/produtos_sem_foto.php" class="border-slate-900 border-2 rounded-2xl ml-6 p-2 text-black  hover:bg-gray-200">
        Produtos em estoque sem foto na pasta
</a>
<a href="http://192.168.30.252:9091/ProjetoXoPlanilha/outlet/processa_pecas_desativadas.php" class="border-slate-900 border-2 rounded-2xl ml-6 p-2 text-black  hover:bg-gray-200">
        Peças na pasta DESATIVADAS que possuem estoque, mas menor que 3 qtd.
</a>
...
<div class="flex justify-between w-screen mt-8 ml-6 ">
    ...
    <?php  if($incorrectImageCount === 0 && $desabilitaBotaoOutlet === false ) { ?>
