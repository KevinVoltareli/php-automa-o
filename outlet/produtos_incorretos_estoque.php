...
$sourceDir = '\\\\192.168.30.200\\dados$\\Depto E-Commerce\\teste\\outlet\\';
$destinationDir = '\\\\192.168.30.200\\dados$\\Depto Marketing\\DESATIVADAS\\outlet\\';

try {
    $conn = new PDO("firebird:dbname=C:\SavWinRevo\Servidor\DataBase\BDSAVWINREVO.FDB", "SYSDBA", "masterkey");
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    $sql = "SELECT a.MATDTCADASTRO AS DT_CADASTRO, a.MATFANTASIA AS FANTASIA, h.ACNDESCRICAO as ACNDESCRICAO, g.argdescricao AS GRIFE
, g.argtipoprod AS TIPO_GRIFE, a.MATSEQUENCIAL AS COD_SEQUENCIAL, d.pesnome AS NOME_LOJA, j.ARMDESCRICAO AS MODELO,
        CAST(b.MECQUANTIDADE1 AS INT) AS QUANTIDADE, i.MPVPRECOVENDA AS PRECO,i.MPVDTALTERACAO AS DTALT
        ...
        WHERE c.filid = 5
        AND g.argtipoprod = 'A'
        AND a.MATFANTASIA LIKE '%OUTLET%'
        GROUP BY a.MATDTCADASTRO, a.MATFANTASIA, h.ACNDESCRICAO, g.argdescricao, g.argtipoprod, a.MATSEQUENCIAL, d.pesnome,  i.MPVPRECOVENDA,b.MECQUANTIDADE1,j.ARMDESCRICAO, QUANTIDADE,DTALT";
...
<div class="flex flex-col w-full">
            ...
            <div class="flex flex-col ">
                <div class="w-full  bg-white shadow-lg rounded-sm border border-gray-200">
                    <header class="px-5 py-4 border-b border-gray-100">
                        <h2 class="font-semibold text-gray-800">Produtos com Preços Incorretos pasta produto COM estoque</h2>
                    </header>
                    <div class="p-3">
    ...
    if (!empty($produtosComPrecosIncorretos)) { ?>
        <form method='post' action='confirmar_alteracao_estoque.php'>
            <input type='hidden' name='confirmar_alteracao_estoque' value='1'>
